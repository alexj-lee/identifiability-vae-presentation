...
::: {.column width="60%"}
<img src="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9380471/bin/nihms-1812939-f0001.jpg" style="width: 80%; height: 80%; position: relative; left: -10rem">
:::

::: {.column width="30%"}
<img src="assets/replogle.png" style="width: 180%; height: 180%; max-width: 180%; max-height: 180%; position: relative; left: -20rem">
...
<h4>Dataset has 14 classes; performs at least as well as comparator model (~90% accuracy) </h4>
<div style="display: flex; flex-direction: row">
...
<ul>
<li> Novel decoder / prediction architecture has clear utility </li>
...
For iVAE, the message was really about conditional independence of $\mathbf{u}$ and $\mathbf{z}$, with no direct parameterization of $\mathbf{z}\mid\mathbf{x}$

<br>
For sVAE+, we have a very different overall interpretation, where the main message is not so much conditional independence but sparse association of treatments and factors
<br>  <br>
Then, for CLAP the method is much more focused on interpretability, and the anticausal model plays a strong role